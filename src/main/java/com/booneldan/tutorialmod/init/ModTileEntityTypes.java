...
public class ModTileEntityTypes {
    ...
    public static final RegistryObject<TileEntityType<ExampleChestTileEntity>> EXAMPLE_CHEST = TILE_ENTITY_TYPES.register("example_chest", () -> TileEntityType.Builder.of(ExampleChestTileEntity::new, NewBlockInit.EXAMPLE_CHEST.get()).build(null));
